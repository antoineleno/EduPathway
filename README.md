...
| **Nouhan Doumbouya**      | Frontend Developer         | Front-end development (HTML, CSS, Bootstrap), template integration, UI customization, and JavaScript interactivity. <br> &nbsp;&nbsp;•  Developed admin dashboard for managing programs, courses, resources, projects, and quizzes <br> &nbsp;&nbsp;• UI customization <br> &nbsp;&nbsp;• JavaScript interactivity <br> &nbsp;&nbsp;• Page responsiveness |
